...
if __name__ == '__main__':
    ...
    m.add_argument("--overlap_demucs", type=float, help="Overlap of splited audio for light models. Closer to 1.0 - slower", required=False, default=0.2)
    m.add_argument("--overlap_VOCFT", type=float, help="Overlap of splited audio for heavy models. Closer to 1.0 - slower", required=False, default=0.2)
    m.add_argument("--overlap_VitLarge", type=int, help="Overlap of splited audio for heavy models. Closer to 1.0 - slower", required=False, default=0.2)
    m.add_argument("--overlap_InstVoc", type=int, help="MDXv3 overlap", required=False, default=8)
    m.add_argument("--weight_InstVoc", type=float, help="Weight of MDXv3 model", required=False, default=6)
    m.add_argument("--weight_VOCFT", type=float, help="Weight of VOC-FT model", required=False, default=2)
    m.add_argument("--weight_VitLarge", type=float, help="Weight of VitLarge model", required=False, default=2)
